...
DATATYPE_LOCATIONS.append('ipad.datatypes')
FUNCTION_LOCATIONS.append('ipad.functions')
...
SECRET_KEY = 'django-insecure-si^xp-hqpk3s(ple=7#v0)cu^0qc&0_#xc=0y5w7i^*!1w5k-f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "ipad.urls"
ROOT_HOSTCONF = "ipad.hosts"
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "ipad",  # Ensure the project is listed before any other arches applications
    "rest_framework",
...
APP_TITLE = 'IPAD Indonesian Prehistoric Archaeology Database'
...
# IPAD public-data policy (recorded only; this change does not grant permissions, reindex, or alter Resource Exporter):
# - Public graphs: ALL resource models/graphs. When a graph is published, it should be public
#   (including future graphs). Unpublished graphs stay non-public until published.
# - Guest: view_resourceinstance plus read of public-safe cards/nodegroups only.
# - Do not grant Guest permissions on existing Draft instances in this task.
# - Do not change Resource Exporter. Do not reindex.
...
# ES_MAPPING_MODIFIER_CLASSES is set above for arches-controlled-lists.
